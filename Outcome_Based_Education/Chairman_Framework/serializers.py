...
from .models import PEO, Vision, Mission, PLO, CLO, Courses, Cognitive_Domain, Psychomotor_Domain, Affective_Domain, CourseAssign
from taggit.models import Tag
from taggit_serializer.serializers import (TagListSerializerField,
                                           TaggitSerializer)
import six
from Accounts.serializers import TeacherRegisterSerializer
# peo
...
class CourseAssignSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        self.fields['teacher_name'] = TeacherRegisterSerializer(
            read_only=True, many=True)
        self.fields['subjects'] = CoursesSerializer(read_only=True, many=True)
        return super(CourseAssignSerializer, self).to_representation(instance)
